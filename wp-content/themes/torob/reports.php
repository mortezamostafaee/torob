...
<div class="tab">
    ...
    <button class="tablinks" id="defaultOpen" onclick="openCity(event, 'merge')">
        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"
...
<div class="main-dashbord">
    <div class="report-torob">
        <h5 class="mb-4">وضعیت درخواست‌های شما در این هفته</h5>
        <div class="d-flex gap-5">
            <div class="request">
                <div class="request-header1">
                    <p>میانگین صحت درخواست‌ها</p>
                </div>
                <div class="request-main">0%</div>
            </div>
            <div class="request">
                <div class="request-header2 d-flex">
                    <div class="w-50 request-header-right">
                        <p>تعداد درخواست‌</p>
                    </div>
                    <div class="w-50 request-header-left">
                        <p>های بررسی شده</p>
                    </div>
                </div>
                <div class="request-main">0</div>
                <div class="request-header2 d-flex">
                    <div class="w-50 request-bottom-right">
                        <p>درست:0</p>
                    </div>
                    <div class="w-50 request-bottom-left">
                        <p>غلط:0</p>
                    </div>
                </div>
            </div>
            <div class="request">
                <div class="request-header3">

                <p>تعداد درخواست‌های درانتظار بررسی</p>
                </div>
                <div class="request-main">0</div>
            </div>
            ...
            <h5 class="mt-3 mb-4">جدول تغییر محدودیت تعداد درخواست روزانه</h5>

        <table class="table text-center">
            <thead>
            <tr>
                <th scope="col">میانگین صحت درخواست‌ها در طول هفته</th>
                <th scope="col">محدودیت تعداد درخواست روزانه</th>
                <th scope="col">رأی‌گیری
                    <div class="vertical-wrapper" style="width: auto;display: inline-block;">
            ...
            <tbody>
            <tr>
                <th scope="row">فروشگاه جدید</th>
                <td>50 درخواست</td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(215, 57, 72); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(76, 175, 80); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg> </td>
            </tr>
            <tr>
                <th scope="row">کمتر از ۷۰ درصد صحیح</th>
                <td>10 درخواست</td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(215, 57, 72); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(76, 175, 80); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg> </td>
            </tr>
            <tr>
                <th scope="row">۷۰ تا ۹۰ درصد صحیح</th>
                <td>70 درخواست</td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(215, 57, 72); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> </td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(76, 175, 80); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg> </td>
            </tr>
            <tr>
                <th scope="row">۹۰ تا ۹۵ درصد صحیح</th>
                <td>100 درخواست</td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(215, 57, 72); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> </td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(76, 175, 80); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg> </td>
            </tr>
            <tr>
                <th scope="row">۹۵ تا ۹۹ درصد صحیح</th>
                <td>300 درخواست</td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(215, 57, 72); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> </td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(76, 175, 80); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg> </td>
            </tr>
            <tr>
                <th scope="row">بالای ۹۹ درصد صحیح</th>
                <td>500 درخواست</td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(76, 175, 80); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg> </td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(76, 175, 80); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg> </td>
            </tr>
            <tr>
                <th scope="row">فروشگاه تخصصی</th>
                <td>1000 درخواست</td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(76, 175, 80); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg> </td>
                <td><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" style="color: rgb(76, 175, 80); vertical-align: middle; fill: none;" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline></svg></td>
            </tr>
        ...
        <ul class="text-center">
            <li>برای تغییر محدودیت «تعداد درخواست روزانه» در طول هفته اخیر باید حداقل ۲۰ درخواست ادغام / جداسازی بررسی شده داشته باشید.</li>
            <li>محدودیت «تعداد درخواست روزانه» هر جمعه بین ساعت ۱۱ تا ۱۲ شب براساس دقت درخواست‌ها محاسبه و اعمال می‌شود.</li>
            <li>در صورتی که «درخواست بازنگری» شما روی هر درخواستی «رد» شود، یک درخواست جداگانه محاسبه می‌شود. </li>
            <li>در حال حاضر مشارکت در بخش رأی گیری از سهم حداکثر درخواست روزانه شما کسر نمی‌کند.</li>
        </ul>
    </div>
