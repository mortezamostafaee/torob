...
<?php if (is_user_logged_in()): ?>
    ...
    <div id="merge" class="tabcontent">
        <div class="accordion-text">
            <div class="accordion">
                ...
                <a href="<?php echo get_home_url() . '/product-pane' ?>" class="a-accordion" style="background: #4a90e2; color: #fff">محصولات فروشگاه</a>
    ...
    <button id="hide" class="hide-text"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
        ...
        <p class="mb-3">ادغام / محصولات فروشگاه</p>
    </span>
    <div class="main-dashbord">
        <div class="request-history">
            <form method="post" action="">
                <div class="row">
                    <div class="col-md-2">
                        <label for="type-of-request">نوع درخواست</label>
                        <select class="js-example-basic-single w-100" name="type-of-request" dir="auto">
                            <option value="همه">همه</option>
                            <option value="ادغام">ادغام</option>
                            <option value="جداسازی">جداسازی</option>
                            <option value="تغییر بسته بندی">تغییر بسته بندی</option>
                            <option value="بازگردانی از حذف">بازگردانی از حذف</option>
                        </select>
                    </div>
                    <div class="col-md-2">
                        <label for="status-request">وضعیت درخواست</label>
                        <select class="js-example-basic-single w-100" name="status-request" dir="auto">
                            <option value="همه">همه</option>
                    ...
                    <div class="col-md-2">
                        <label for="id-request">شناسه درخواست</label>
                        <input type="text" value="" class="w-100" name="id-request" dir="auto"
                               style="border: solid 1px #8f8f9d;border-radius: 3px;">
                    </div>
                    <div class="col-md-2">
                        <label for="product-category">دسته بندی محصول</label><br>
                        <select class="js-example-basic-multiple" name="term[]" multiple="multiple" style="margin-top: 10px; width: 100%;" dir="auto">
         ...
         <p class="notice-filter">اگر محصول خود را پیدا نمی‌کنید به فیلترها دقت کنید</p>
            <hr>
            <form method="post">
                <div class="row">
                    <div class="col-md-4">
