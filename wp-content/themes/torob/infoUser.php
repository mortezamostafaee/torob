    ...
    <div class="d-flex justify-content-center">
       <div class="new-shop-content">
          <div class="d-flex justify-content-between reg-shop">
           ...
           <form>
               <label class="lale-user">شماره موبایل </label><br>
               <input type="text" name="phone-user" class="w-75 user-form" dir="auto" value="<?php echo get_post_meta($shop->ID, 'phone')[0]?>"><br>
               <label class="lale-user"> آدرس ایمیل </label><br>
               <input type="text" name="email-user" class="w-75 user-form" dir="auto" value="<?php echo $current_user->user_email; ?>" disabled><br>
               <label class="lale-user">  نام و نام خانوادگی </label><br>
               <input type="text" name="name-user" class="w-75 user-form"  dir="auto" value="<?php echo get_post_meta($shop->ID, 'name_1')[0]?>" disabled>
               <button type="submit" name="update" value="بروز رسانی" class="btn btn-success">بروز رسانی</button>
           </form>
       </div>
    </div>
