...
<div class="tab">
    ...
    <button class="tablinks" <?php echo is_user_logged_in() ? '' : 'disabled' ?> onclick="openCity(event, 'merge')">
        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"
...
<div id="shop" class="tabcontent">
    <div class="accordion">
        ...
        <li class="accordion-item" id="accordion-item-4">
            <a class="accordion-item-header" href="#accordion-item-4" style="background: #f8f9fa;">
                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"
                     stroke-linejoin="round" height="17" width="17" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="accordion-text">
                <a href="<?php echo get_home_url() . '/invoice/#accordion-item-4' ?>" class="a-accordion" style="background: #4a90e2;color: #fff;">صورت حساب ها</a>
            </div>
        </li>
...
<div id="merge" class="tabcontent">
    ...
    <div class="accordion">
        ...
        <a href="<?php echo get_home_url() . '/reports' ?>" class="a-accordion"
           style="background: #4a90e2; color: #fff">گزارشات</a>
...
<div class="main-dashbord d-flex">
    <div class="main-dashbord-p maine-invoice">
        <div>
            <p class="alert-info">در صورتی که نیاز به دریافت فاکتور رسمی دارید قبل از شارژ حساب مشخصات مورد نیاز برای
                فاکتور رسمی را ثبت کنید.</p>
        </div>
        <div class="row mb-4 alert-sucsess">
            <div class="col-md-3 d-flex justify-content-center align-items-center">
                <span> موجودی حساب شما</span><span style="font-size: 20px;font-weight: bold;">0</span><span>تومان</span>
            </div>
            <div class="col-md-7 d-flex justify-content-center align-items-center gap-1">
                <span>افزایش‌ موجودی</span>
                <select class="js-example-basic-single w-50" name="type-of-request" dir="auto"
                        style="border: solid 1px #e5e5e5;background: #fff;padding: 9px;border-radius: 5px; font-size: 12px;">
                    <option value="100 هزار تومان + 9 درصد مالیات">100 هزار تومان + 9 درصد مالیات</option>
                    <option value="200 هزار تومان + 9 درصد مالیات">200 هزار تومان + 9 درصد مالیات</option>
                    <option value="300 هزار تومان + 9 درصد مالیات">300 هزار تومان + 9 درصد مالیات</option>
                    <option value="500 هزار تومان + 9 درصد مالیات">500 هزار تومان + 9 درصد مالیات</option>
                    <option value="1 میلیون تومان + 9 درصد مالیات">1 میلیون تومان + 9 درصد مالیات</option>
                    <option value="2 میلیون تومان + 9 درصد مالیات">2 میلیون تومان + 9 درصد مالیات</option>
                </select>
                <button type="submit" class="btn btn-success">پرداخت</button>
            </div>
            <div class="col-md-2">
                <a href="#" style="text-align: center !important;direction: unset !important;line-height: 25px;">
                    دستورالعمل عدم نیاز به گواهی ارزش‌افزوده
                </a>
            </div>
        </div>
        <hr>
        <table class="w-100">
            <thead style="border-bottom: solid 2px #e5e5e5;">
            <tr>
                <th>شماره</th>
                <th>نوع فاکتور</th>
                <th>تاریخ</th>
