<?php
/* Template Name: dashbord content*/
get_header();
global $wpdb;
...
<body class="dashbord-content page-<?php echo get_the_ID() ?>">
<div class="tab">
    <button class="tablinks" id="<?php echo $url=='faq' ||  $url=='special-offer-page-rows'||  $url=='special-offer-page-banner' ||  $url=='terms' ||  $url=='changes'  ||  $url=='contact-support' ? 'defaultOpen' : ''?>" onclick="openCity(event, 'shop')">
        ...
        <br><span>فروشگاه</span>
    </button>

    <button class="tablinks" id="<?php echo $url=='faq' ? '' : 'defaultOpen'?>" onclick="openCity(event, 'merge')">
        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"
    ...
    <div class="accordion">
        ...
        <li class="accordion-item" id="accordion-item-3">
            ...
            <div class="accordion-text">
                ...
                <a href="<?php echo get_home_url() . '/special-offer-page-banner/#accordion-item-3' ?>" class="a-accordion <?php echo $url=='special-offer-page-banner' ? 'dashbord-url' : ''?>">بنر صفحه پیشنهادات ویژه</a>
                <a href="<?php echo get_home_url() . '/special-offer-page-rows/#accordion-item-3' ?>" class="a-accordion <?php echo $url=='special-offer-page-rows' ? 'dashbord-url' : ''?>">ردیف‌های صفحه پیشنهاد ویژه</a>
            </div>
        </li>
        ...
        <li class="accordion-item" id="accordion-item-5">
            <a class="accordion-item-header <?php echo $url=='changes' || $url=='faq' || $url=='contact-support' || $url=='terms' ? 'dashbord-url' : ''?>" href="#accordion-item-5">
                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"
                     stroke-linejoin="round" height="17" width="17" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="accordion-text">
                <a href="<?php echo get_home_url() . '/faq/#accordion-item-5' ?>" class="a-accordion <?php echo $url=='faq' ? 'dashbord-url' : ''?>">پرسشهای متداول</a>
                <a href="<?php echo get_home_url() . '/terms/#accordion-item-5' ?>" class="a-accordion <?php echo $url=='terms' ? 'dashbord-url' : ''?>">شرایط همکاری</a>
                <a href="<?php echo get_home_url() . '/changes/#accordion-item-5' ?>" class="a-accordion <?php echo $url=='changes' ? 'dashbord-url' : ''?>"> آخرین تغییرات</a>
                <a href="<?php echo get_home_url() . '/contact-support/#accordion-item-5' ?>" class="a-accordion <?php echo $url=='contact-support' ? 'dashbord-url' : ''?>">تماس با پشتیبانی</a>
            </div>
        </li>
    </div>
</div>
...
<div id="merge" class="tabcontent">
    <div class="accordion-text ">
        <div class="accordion">
            ...
            <a href="<?php echo get_home_url() . '/request-history' ?>" class="a-accordion <?php echo $url=='request-history' ? 'dashbord-url' : ''?>">تاریخچه و درخواست ها</a>
            <a href="<?php echo get_home_url() . '/reports' ?>" class="a-accordion <?php echo $url=='reports' ? 'dashbord-url' : ''?>">گزارشات</a>
            <a href="<?php echo get_home_url() . '/guide' ?>" class="a-accordion <?php echo $url=='guide' ? 'dashbord-url' : ''?>">راهنما</a>
        </div>
    </div>
</div>
...
<div class="main-dashbord d-flex">
    <?php
    get_header();
    if (have_posts()) :
        while (have_posts()) : the_post();
            ...
            <span class="main-content"><?php the_content(); ?></span>
        <?php
        endwhile;
    endif;
    ?>
