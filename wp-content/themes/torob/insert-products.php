...
if (isset($_POST['submit'])) {
    if (!empty($_POST['product-name'])){
        ...
        $wpdb->insert( $torob_main_product, array(
...
<form method="post" action="" class="widefat repeater">
    ...
    <select class="js-example-basic-multiple" name="term[]" multiple="multiple"
            style="margin-top: 10px; width: 31%;"><?php foreach ($terms as $term) { ?>
            <option><?php echo $term->name; ?></option><?php } ?></select><br><br>
    <label for="product-image">لینک تصویر محصول</label><br>
    <input type="text" id="url-image-product" name="url-image-product" dir="auto" style="width: 31%;">
    <input type="button" class="btn button-primary" value="انتخاب" name="image" id="product-image"><br>
    <input type="submit" value="ذخیره" class="button-primary" name="submit" style="margin-top: 10px;">
</form>
